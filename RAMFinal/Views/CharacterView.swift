...
class CharacterView: UIView, UIScrollViewDelegate {
    ...
    var goToCVWidth: NSLayoutConstraint!
    ...
    self.goToTVWidth = self.goToTV.widthAnchor.constraint(equalToConstant: UIScreen.main.bounds.width * 0.15)
    ...
    self.goToCVWidth = self.goToCV.widthAnchor.constraint(equalToConstant: UIScreen.main.bounds.width * 0.15)
    self.goToCVWidth.isActive = true
        self.goToCV.addTarget(self, action: #selector(goToCVfunc), for: .touchUpInside)
